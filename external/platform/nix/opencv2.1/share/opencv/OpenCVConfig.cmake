...
# ======================================================
INCLUDE_DIRECTORIES(/home/danny/sandbox/viz/external/platform/nix/opencv2.1/include/opencv)
# Provide the include directories to the caller
SET(OpenCV_INCLUDE_DIRS /home/danny/sandbox/viz/external/platform/nix/opencv2.1/include/opencv)

# ======================================================
# Link directories to add to the user project:
# ======================================================
LINK_DIRECTORIES("/home/danny/sandbox/viz/external/platform/nix/opencv2.1/lib")
# Provide the libs directory anyway, it may be needed in some cases.
SET(OpenCV_LIB_DIR "/home/danny/sandbox/viz/external/platform/nix/opencv2.1/lib")
...
IF (NOT 1)
	...
	LINK_DIRECTORIES("/home/danny/sandbox/external/opencv2.1bin/3rdparty/lib")
